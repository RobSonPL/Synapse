...
export const SynapseLogo = ({ className = "w-10 h-10" }: { className?: string }) => {
  ...
  if (error) {
    return (
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <defs>
          <linearGradient id="synapseGradient" x1="10%" y1="10%" x2="90%" y2="90%">
            <stop offset="0%" stopColor="#0ea5e9" />
            <stop offset="100%" stopColor="#6366f1" />
          </linearGradient>
        </defs>
        <circle cx="50" cy="50" r="46" stroke="url(#synapseGradient)" strokeWidth="3" opacity="0.8" />
        <path
          d="M68 28 C 45 28, 30 42, 50 52 C 70 62, 55 78, 32 72"
  ...
  return (
    <img 
      src="https://drive.google.com/thumbnail?id=1dz1rQ6Ukylhqu28UoQwdkZoqz2PhTiYJ&sz=w200" 
      alt="Synapse Creative" 
      referrerPolicy="no-referrer"
      onError={() => setError(true)}
      className={`${className} object-cover rounded-full shadow-md bg-white`}
    />
  );
};
...
export const AwardIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15l-2 5l2 1l2-1l-2-5zm0 0l-2-5l2-1l2 1l-2 5zm0 0h4m-4 0h-4M12 3a6 6 0 1 0 0 12a6 6 0 0 0 0-12z" />
  </svg>
);
...
export const CourseIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
  </svg>
);

export const GraphicIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const PenIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const QuoteIcon = ({ className = "w-10 h-10" }: { className?: string }) => (
